...
const _courts = [
  {'id': 1, 'name': 'ETL Food Court', 'location': 'Sector 50, Noida'},
  {'id': 2, 'name': 'ETL Court 2', 'location': 'Sector 62, Noida'},
  {'id': 3, 'name': 'ETL Court 3', 'location': 'Sector 18, Noida'},
];
                  ...
                  child: AnimatedScale(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: _white.withOpacity(_backPressed ? 0.22 : 0.12),
                        ),
                      ),
                      child: Row(
